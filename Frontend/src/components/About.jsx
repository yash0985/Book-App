...
function About() {
  return (
    <div className="container mx-auto my-12 p-4 space-y-9 text-white">
      <h1 className="text-2xl text-blue-700 font-bold mb-6">About</h1>
      <p>
        This is{" "}
        <strong className="text-fuchsia-700  font-semibold hover:scale-105 duration-500">
          Yash
        </strong>{" "}
        ...
        dynamic, responsive, and user-friendly web applications, Yash excels in
      ...
      <p>
        Beyond his professional achievements, Yash is a big fan of cricket and
        ...
        significantly shaped Yash’s journey. Ankush is not only a great
        competitor but also a steadfast friend, constantly motivating Yash to
